    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          <ol
            role="list"
            className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8 mb-8"
          >
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
             ...
             {products.product?.discountPresent} % off
              ...
              <p className="opacity-50 text-sm">57587 ratimngs</p>
              <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">57 reviews</p>
              </div>
              </div>
...
{/* Rating & reviws */}
        ...
        <section>
          ...
          <h1 className="font-semibold text-lg pb-4 ">Recents Reviews and Ratings</h1>
                      ...
                      <div className="flex items-center space-x-3"> 
                        <Rating name="readOnly" value={4.1} precision={0.5} readOnly/>
                        <p className="opacity-60">65 Ratings</p>
                      </div>
    ...
    <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant="determinate" value={25} color="primary" />
                        ...
                        <Grid item xs={7}>
    <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant="determinate" value={10} color="warning" />
</Grid>
                        </Grid>
                        <Grid container alignItems="center" gap={2}>
                        <Grid item xs={2}>
                        ...
                        <Grid item xs={7}>
    <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant="determinate" value={5} color="error" />
</Grid>
